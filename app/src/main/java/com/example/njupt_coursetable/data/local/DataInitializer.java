...
public class DataInitializer {
    ...
    private void addSampleCourses() {
        ...
        // 添加全周课程（每周都有）
        allCourses.add(new Course("体育", "体育馆", "1-18周", "周一", "7-8节", "体育老师", "pe@njupt.edu.cn", "必修", "", "全周"));
        allCourses.add(new Course("思想政治", "教一-201", "1-18周", "周三", "7-8节", "思政老师", "sz@njupt.edu.cn", "必修", "", "全周"));
        
        // 添加单周课程（1,3,5,7,9,11,13,15,17周）
        // 周一课程 - 上午和下午分散
        allCourses.add(new Course("高等数学", "教二-101", "1-18周", "周一", "1-2节", "张老师", "zhang@njupt.edu.cn", "必修", "", "单周"));
        allCourses.add(new Course("线性代数", "教三-201", "1-18周", "周一", "5-6节", "李老师", "li@njupt.edu.cn", "必修", "", "单周"));
        
        // 周二课程 - 上午和下午分散
        allCourses.add(new Course("大学英语", "教一-301", "1-18周", "周二", "3-4节", "王老师", "wang@njupt.edu.cn", "必修", "", "单周"));
        
        // 周三课程 - 只有上午
        allCourses.add(new Course("数据结构", "教二-102", "1-18周", "周三", "1-2节", "刘老师", "liu@njupt.edu.cn", "必修", "", "单周"));
        
        // 周四课程 - 下午和晚上分散
        allCourses.add(new Course("操作系统", "教一-302", "1-18周", "周四", "3-4节", "杨老师", "yang@njupt.edu.cn", "必修", "", "单周"));
        allCourses.add(new Course("数据库原理", "教四-402", "1-18周", "周四", "9-10节", "黄老师", "huang@njupt.edu.cn", "必修", "", "单周"));
        
        // 周五课程 - 只有上午
        allCourses.add(new Course("软件工程", "教二-103", "1-18周", "周五", "1-2节", "周老师", "zhou@njupt.edu.cn", "选修", "", "单周"));
        
        // 添加双周课程（2,4,6,8,10,12,14,16,18周）
        // 周一课程 - 只有下午
        allCourses.add(new Course("离散数学", "教二-104", "1-18周", "周一", "3-4节", "孙老师", "sun@njupt.edu.cn", "必修", "", "双周"));
        
        // 周二课程 - 上午和晚上分散
        allCourses.add(new Course("日语", "教一-304", "1-18周", "周二", "1-2节", "冯老师", "feng@njupt.edu.cn", "选修", "", "双周"));
        allCourses.add(new Course("C语言程序设计", "教四-401", "1-18周", "周二", "9-10节", "赵老师", "zhao@njupt.edu.cn", "必修", "", "双周"));
        
        // 周三课程 - 下午和晚上分散
        allCourses.add(new Course("计算机网络", "教三-202", "1-18周", "周三", "5-6节", "陈老师", "chen@njupt.edu.cn", "必修", "", "双周"));
        
        // 周四课程 - 只有上午
        allCourses.add(new Course("概率论与数理统计", "教三-204", "1-18周", "周四", "1-2节", "钱老师", "qian@njupt.edu.cn", "必修", "", "双周"));
        
        // 周五课程 - 下午和晚上分散
        allCourses.add(new Course("人工智能导论", "教三-203", "1-18周", "周五", "3-4节", "吴老师", "wu@njupt.edu.cn", "选修", "", "双周"));
        allCourses.add(new Course("Web开发技术", "教二-106", "1-18周", "周五", "7-8节", "朱老师", "zhu@njupt.edu.cn", "选修", "", "双周"));
